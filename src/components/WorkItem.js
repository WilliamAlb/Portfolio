...
export function WorkItem(props){
    ...
    return(
        <div className={props.right?'work-item-right':'work-item-left'} ref={ref}>
            <div className="work-img-div"><a href={props.workItem.link} target="_blank" rel="noreferrer"><img src={props.workItem.picture} alt='work example' loading="lazy"></img></a></div>
